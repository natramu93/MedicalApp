...
# web application at http://natramu93.pythonanywhere.com/
...
#import sys
#
#path = '/home/natramu93/path/to/my/app
...
## assuming your django settings file is at '/home/natramu93/mysite/mysite/settings.py'
## and your manage.py is is at '/home/natramu93/mysite/manage.py'
path = '/home/natramu93/MedicalApp'
if path not in sys.path:
    sys.path.append(path)

os.environ['DJANGO_SETTINGS_MODULE'] = 'MedicalApp.settings'
...
#import sys
#
## The "/home/natramu93" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/natramu93/myproject"
#path = '/home/natramu93/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
